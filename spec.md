...
- **Lượt 2 (chiều 17/9, trước CP4) — chạy lại tự động qua script gọi thẳng `/generate`, đã đọc nội dung đối chiếu kỳ vọng đầy đủ (xem Case 27-28, `eval/golden-set.md`):**
  ...
  - Case 18, 19 vẫn còn lỗi CŨ từ lượt 1 (không giải nghĩa tiếng Việt cho thuật ngữ; chưa đổi độ sâu theo đối tượng chuyên môn) — chưa sửa, để lại kế hoạch ở mục "Việc CHƯA giải quyết".
